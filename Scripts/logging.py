...
def print_comments(
    current, config, scanVideoID, comments, loggingEnabled, scanMode, logMode=None
):
    ...
    if loggingEnabled == True:
        ...
        logFileContents = (
            commentsContents + matchSamplesContent + duplicateSamplesContent
        )
    else:
...
def print_prepared_comments(
    ...
    for comment in comments:
        ...
        print(
            f"     > Author Channel ID: {F.LIGHTBLUE_EX}" + author_id_local + f"{S.R}"
        )
        print(
            "=============================================================================================\n"
        )
    ...
    if config:
        try:
            ...
            if config["json_log"] == True:
                ...
                print(
                    "Invalid value for 'json_log' in config file:  "
                    + config["json_log"]
                )
            ...
            if config["json_profile_picture"] != False:
                jsonSettingsDict["json_profile_picture"] = config[
