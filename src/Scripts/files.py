...
from Scripts.shared_imports import RESOURCES_FOLDER_NAME, B, F, S
...
def load_config_file(configVersion: int | None = None, forceDefault: bool = False, skipConfigChoice: bool = False, onlyGetSettings: bool = False, configFileName: str = "SpamPurgeConfig.ini", configFolder: str = "configs",
):
